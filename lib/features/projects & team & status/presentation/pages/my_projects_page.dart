...
class _MyProjectsPageState extends State<MyProjectsPage> {
  ...
  void didChangeDependencies() {
    context.read<ProjectStatusTeamBloc>().add(ShowUserProjectsEvent());
          ...
          children: [
            ...
            Flexible(
              child: BlocBuilder<ProjectStatusTeamBloc, ProjectStatusTeamState>(
                buildWhen:
                    (previous, current) =>
                        (previous.userProjectsListStatus !=
                            current.userProjectsListStatus),
                builder: (context, state) {
                  return ProjectBlocStateHandling().getUserProjectsTable(state);
                },
              ),
            ),
          ],
