...
class ContractManagerApproveContractUsecase
    extends UseCase<Future<Either<Failure, Unit>>, ApproveContractParam> {
  final ContractRepo contractRepo;

  ContractManagerApproveContractUsecase(this.contractRepo);

  @override
  Future<Either<Failure, Unit>> call(ApproveContractParam param) {
    return contractRepo.contractManagerApproveContract(param);
  }
}
