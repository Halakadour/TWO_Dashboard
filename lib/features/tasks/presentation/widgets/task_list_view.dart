...
import 'package:two_dashboard/features/tasks/presentation/widgets/task_list_tile.dart';

import 'task_status_title_and_task_count.dart';

class TaskListView extends StatefulWidget {
  const TaskListView({super.key, required this.colorStatus});
        ...
        Expanded(
          ...
          child: Container(
            ...
            child: ListView.builder(
              ...
              itemBuilder:
                  (context, index) =>
                      TaskListTile(colorStatus: widget.colorStatus),
            ),
          ),
        ),
      ],
