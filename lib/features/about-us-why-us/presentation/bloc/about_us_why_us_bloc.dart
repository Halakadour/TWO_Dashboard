  ...
  AboutUsWhyUsBloc(
    ...
    on<CreateAboutUsEvent>((event, emit) async {
      ...
      if (token != null) {
        ...
        emit(
          state.copyWith(
            createAboutUsStatus: CasualStatus.noToken,
            message: "No Token",
          ),
        );
      }
    ...
    on<UpdateAboutUsEvent>((event, emit) async {
      ...
      if (token != null) {
        ...
        emit(
          state.copyWith(
            updateAboutUsStatus: CasualStatus.noToken,
            message: "No Token",
          ),
        );
      }
    ...
    on<CreateWhyUsEvent>((event, emit) async {
      ...
      if (token != null) {
        ...
        emit(
          state.copyWith(
            createWhyUsStatus: CasualStatus.noToken,
            message: "No Token",
          ),
        );
      }
    ...
    on<UpdateWhyUsEvent>((event, emit) async {
      ...
      if (token != null) {
        ...
        emit(
          state.copyWith(
            updateWhyUsStatus: CasualStatus.noToken,
            message: "No Token",
          ),
        );
      }
    ...
    on<DeleteWhyUsEvent>((event, emit) async {
      ...
      if (token != null) {
        ...
        emit(
          state.copyWith(
            deleteWhyUsStatus: CasualStatus.noToken,
            message: "No Token",
          ),
        );
      }
