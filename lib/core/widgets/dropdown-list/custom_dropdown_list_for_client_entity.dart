...
class CustomDropdownListForClientEntity extends StatelessWidget {
  const CustomDropdownListForClientEntity({
    super.key,
  ...
  final List<DropdownMenuItem<ClientEntity>>? items;
  final void Function(ClientEntity?)? onChanged;
